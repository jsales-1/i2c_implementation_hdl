...
module i2c_multi_slave_tb;
    ...
    initial begin
        ...
        if (slave0_data_received == 8'h11)
            $display("OK WRITE1 Slave0: %h", slave0_data_received);
        else
            $display("ERRO WRITE1 Slave0: %h", slave0_data_received);
        ...
        if (slave0_data_received == 8'h22)
            $display("OK WRITE2 Slave0: %h", slave0_data_received);
        else
            $display("ERRO WRITE2 Slave0: %h", slave0_data_received);
        ...
        if (slave0_data_received == 8'h33)
            $display("OK WRITE3 Slave0: %h", slave0_data_received);
        else
            $display("ERRO WRITE3 Slave0: %h", slave0_data_received);

        // WRITE 4
        master_data_in = 8'h44;
        enable = 1; #10 enable = 0;
        #400;

        if (slave0_data_received == 8'h44)
            $display("OK WRITE4 Slave0: %h", slave0_data_received);
        else
            $display("ERRO WRITE4 Slave0: %h", slave0_data_received);
