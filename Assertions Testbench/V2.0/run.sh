...
xrun -Q -unbuffered '-timescale' '1ns/1ns' '-sysv' '-access' '+rw' '-coverage' 'all' design.sv testbench.sv  ; echo 'Creating result.zip...' && zip -r /tmp/tmp_zip_file_123play.zip . && mv /tmp/tmp_zip_file_123play.zip result.zip