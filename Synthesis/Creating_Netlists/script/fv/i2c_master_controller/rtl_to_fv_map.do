...
# Generated on: Fri Mar 06 19:02:35 -03 2026 (Fri Mar 06 22:02:35 UTC 2026)
...
set logfile fv/i2c_master_controller/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/i2c_master_controller -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 /prj/ci/workarea/aluno6/Verilog/i2c_implementation_hdl-main/Synthesis/Creating_Netlists/RTL/i2c_master.sv
elaborate_design -golden -root {i2c_master_controller} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/i2c_master_controller/fv_map.v.gz
elaborate_design -revised -root {i2c_master_controller}
...
#add_name_alias fv/i2c_master_controller/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.i2c_master_controller.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.i2c_master_controller.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.i2c_master_controller.rtl.fv_map.rpt
