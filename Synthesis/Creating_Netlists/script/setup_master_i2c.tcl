...
set HDL_FILES ${PROJECT_DIR}/Creating_Netlists/RTL/i2c_master.sv 
...
report_timing > reports_master/report_timing.rpt
report_power  > reports_master/report_power.rpt
report_area   > reports_master/report_area.rpt
