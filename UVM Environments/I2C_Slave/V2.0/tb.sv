...
`ifdef I2C_SLAVE_EXISTS
    // DUT - I2C Slave Controller (comentado por enquanto - sem DUT real)
...
`endif
    ...
    // Set data for slave to send during read operations (simulated)
    initial begin
        #150;
        fork
            forever begin
                @(posedge clk);
                // Randomize data to send for reads (simulated)
  ...
  initial begin
      ...
      // Configurar modo de teste para driver e monitor
